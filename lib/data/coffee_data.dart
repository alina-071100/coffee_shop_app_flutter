...
List<CoffeeModel> coffeeList = [
  CoffeeModel(
    id: "1",
    image: "assets/images/coffee1_large.png",
    name: "Cappuccino",
    ...
    priceItems: 4.0,
    description:
        "A cappuccino is an approximately 150 ml (5 oz) beverage, with 25 ml of espresso coffee and 85ml of fresh milk.  decadent coupling of rich intense espresso, creamy, frothed milk and deep, dark chocolate..",
    isAvailable: true,
  ),
  
  CoffeeModel(
    id: "2",
    image: "assets/images/coffe2_large.png",
    name: "Cappuccino",
    coffeeWith: "with Oat Milk",
    price: 3.0,
    priceItems: 3.0,
    count: 0,
    rate: 4.9,
  ...
  CoffeeModel(
    id: "3",
    image: "assets/images/caramell-macchiato.jpg",
    name: "Iced Espresso",
    coffeeWith: "with Milk",
    price: 3.0,
    priceItems: 3.0,
    count: 0,
    rate: 4.9,
  ...
  CoffeeModel(
    ...
    rate: 5.9,
    description:
        "The iced vanilla macchiato is a sweet caffeinated beverage that’s recently gained popularity. It’s available at most cafes, but we bet you’re here for an easy at-home recipe.",
    isAvailable: true,
  ),
  CoffeeModel(
    id: "6",
    ...
    name: "Mocha Latte",
    coffeeWith: "with Chocolate and Vanilla",
    price: 6.0,
    priceItems: 6.0,
    count: 0,
    rate: 5.2,
  ...
  CoffeeModel(
    id: "7",
    image: "assets/images/coffee6_large.png",
    name: "Cappuccino",
    coffeeWith: "with Flavored",
    price: 8.0,
    priceItems: 8.0,
    count: 0,
    rate: 6.6,
